...
public interface Network <T> { // contratto delle reti
    public T source (); // restituisce il nodo sorgente di this; // null se la sorgente non e’ settata
    public T target (); // restituisce il nodo destinazione di this; // null se la destinazione non e’ settata
    ...
    public void setTarget (T newtarget) throws NoSuchNodeException; // setta la destinazione della rete a newtarget; // lancia l’eccezione se newtarget non e’ un nodo della rete
    public void addNode (T v); // aggiunge a this un nuovo nodo v. // Non fa nulla se v e’ gia’ un nodo della rete
    public void addEdge (T p, T a) throws NoSuchNodeException; // aggiunge a this un nuovo arco, con partenza p e arrivo a. // Lancia l’eccezione se p o a non appartengono alla rete.
